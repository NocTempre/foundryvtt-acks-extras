...
- `scripts/` — ESM runtime, entry `scripts/module.mjs`; `templates/` — .hbs;
  `styles/`; `lang/en.json` — flat i18n keys under root(s) `ACKS-CLASSES, ACKS-LIB, ACKS-ABILITIES, ACKS-EQUIPMENT, ACKS-FACTIONS, ACKS-FORMATION, ACKS-HENCHMEN, ACKS-INFLUENCE, ACKS-LOCATION, ACKS-MONSTERS, ACKS-MARKETS, ACKS-BATTLEMAP, ACKS-VEHICLES, ACKS-IMPORTER, ACKS-CHARACTER, ACKS-BRIDGE`
...
- Namespacing (validate-enforced): globals/custom hooks/HB helpers start with
  ...
  `ACKS-CLASSES, ACKS-LIB, ACKS-ABILITIES, ACKS-EQUIPMENT, ACKS-FACTIONS, ACKS-FORMATION, ACKS-HENCHMEN, ACKS-INFLUENCE, ACKS-LOCATION, ACKS-MONSTERS, ACKS-MARKETS, ACKS-BATTLEMAP, ACKS-VEHICLES, ACKS-IMPORTER, ACKS-CHARACTER, ACKS-BRIDGE`; CSS classes with `acks-extras-`.
