...
| The character sheet | The sheet at the table: the band in the window header, the saves and the vitals on the rails around the portrait, and the Rolls dashboard with every throw and its target | [guide](guides/character-sheet.md) | [v6.4.0](releases/v6.4.0/character-sheet.png) |
