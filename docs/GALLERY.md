...
| Equipment and containers | The item sheet's Construction panel, where what a weapon IS is declared rather than guessed from its name — the type set by hand and the proficiency category that follows from it, the size still on Auto and saying what it read, and the grips and stowage a Judge can answer | [guide](guides/equipment.md) | [v7.2.0](releases/v7.2.0/equipment.png) |
